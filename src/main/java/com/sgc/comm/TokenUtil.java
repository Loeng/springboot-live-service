...
public class TokenUtil {
    ...
    public static void initTokenByProp() {
        ...
        ACCESS_TOKEN =" Bearer " + "YWMtYdwesMhBEeeh8eEdxfMnNQAAAAAAAAAAAAAAAAAAAAEiLOPQvLER578thxb47aJNAgMAAAFftDTL2QBPGgCmdzics8tjIoKDTI7nmaPIybf4VTgJz2dPL1y3E58GiA";
